...
let normal_mobs:string[] = ["Skeleton" , "Zombie" , "Goblin" , "Vampire" , "Warrior" , "Assasin"]
let boss_mobs:string[] = ["Dragon" , "Executioner" , "Wither"]
let user_health = 100
...
let i = 0 
let mobs_killed:string[] = []
function healthdrop(mob:string){
